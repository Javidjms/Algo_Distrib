...
import enshare.client.DistributedClientController;
...
public interface ServerInterface extends Remote {
    ...
    /**
     * Retourne la table de storable document
     * @return storedDocument
     * @throws RemoteException
     */
	public Map<String, StorableDocument>  getStoredDocuments() throws RemoteException ;
	/**
	 * Retourne la table des lecteurs
	 * @return readers la table des lecteurs
	 * @throws RemoteException
	 */
	public Map<String, Set<RemoteControllerInterface>> getReaders() throws RemoteException;
	/**
	 * Retourne la table des écrivains
	 * @return writers la table des écrivains
	 * @throws RemoteException
	 */
	public Map<String, BlockingQueue<RemoteControllerInterface>> getWriters() throws RemoteException;
	/**
	 * Retourne la table des clients connectés au serveur
	 * @return connectedNotepads la table des clients connectés au serveur
	 * @throws RemoteException
	 */
	public Map<String, RemoteControllerInterface> getConnectedNotepads()  throws RemoteException;
	/**
	 * Notifie les autres clients concernant la modification d'un fichier
	 * @param fileName le nom du fichier
	 * @param distributedClientController le client qui effectue la modification du fichier filename
	 * @throws RemoteException
	 */
	public void notifyModificationToClients(String fileName,
			DistributedClientController distributedClientController)throws RemoteException;
